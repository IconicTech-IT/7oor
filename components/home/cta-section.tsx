  ...
  return (
    <div className="w-full bg-background text-foreground">
      <div className="mx-auto flex w-full max-w-4xl flex-col items-center gap-5 px-4 py-16 text-center sm:px-6 sm:py-20 lg:px-8">
        ...
        <ScrollReveal as="p" delay={0.08} className="max-w-lg text-foreground/80">
          {t("subtitle")}
        </ScrollReveal>
        <ScrollReveal
          direction="left"
          delay={0.16}
          className="mt-2 flex items-center justify-center gap-4 text-xs text-foreground/70 sm:gap-6 sm:text-sm"
        >
